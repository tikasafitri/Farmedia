<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Edit Produk Pertanian (Mitra)') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('mitra.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi_produk" rows="3"
                                      class="w-full rounded border-gray-300 dark:bg-gray-900 dark:border-gray-700">{{ old('deskripsi_produk', $product->deskripsi_produk) }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            <label class="block text-sm mb-1">Foto Produk Saat Ini</label>
                        ...
                        <div class="mb-4">
                            <label class="block text-sm mb-1">Ganti Foto Produk (opsional)</label>
